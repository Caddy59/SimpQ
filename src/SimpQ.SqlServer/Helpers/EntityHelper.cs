...
internal static class EntityHelper {
    ...
    internal static TEntity GetEntity<TEntity>(this IDataReader dataReader, ReportEntityConfigurationRegistry? configurationRegistry = null) where TEntity : IReportEntity, new() {
